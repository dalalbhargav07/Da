# -*- coding: utf-8 -*-
"""
Created on Sun Jul  1 12:04:00 2018
...
final_data["DATE_OF_PERMIT_ISSUANCE"] = final_data["DATE_OF_PERMIT_ISSUANCE"].astype(str).apply(lambda x: x.replace("T", " "))
...
final_data['ESTIMATED_VALUE_OF_PROJECT'] = final_data['ESTIMATED_VALUE_OF_PROJECT'].replace(0,final_data['ESTIMATED_VALUE_OF_PROJECT'].mean())
